...
(function (global, $){
    $.fn.slizz = function (options){
        ...
        var prodTemplate = function (product, i){
            ...
            var image = "../img/vinilos/" + product.sku + ".png";

            // quiero que el texto sea la descripcion del producto
             var txt = "";
            txt += "\n<li data-order='" + i + "'>";
            txt += "\n<div class='item'>";
            txt += "\n<a href='#' title='" + product.title + "'>";
            txt += "\n<img class='prodImg' src='" +image +"' alt='" +product.sku +"'>";
            txt += "\n<div class='prodHover'>" + cta + "</div>";
            txt += "\n</a>";
            if (settings.title == true){
                txt += "\n<span class='prodName'>" + product.artist + "</span>";
                txt += "\n<span class='prodName'>" + product.title + "</span>";
                txt += "\n<span class='prodName'>" + product.price + "</span>";
            }
            txt += "\n</div>";
            txt += "\n</li>\n";
            return txt;
